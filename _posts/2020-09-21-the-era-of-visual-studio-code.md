...
Emacs, and Vim's predecessor Vi, were both first released in 1976, before many of todays user-interface conventions were solidified. Predating conventions like using a modifier key with `Z`, `X`, `C`, and `V` for undo, cut, copy, and paste. These keyboard shortcuts were popularized by the [original Macintosh](https://en.wikipedia.org/wiki/Macintosh#1978%E2%80%9384:_Development_and_introduction), released 1985, and [Windows](https://en.wikipedia.org/wiki/Microsoft_Windows), which in 1992 [with the release of Windows 3.1](https://jeffpar.github.io/kbarchive/kb/141/Q141269/). Neither Emacs[^cuamodeinemacs] or Vim use these keys, and instead use their own terminology. They both use the term "yank" for example (although to mean different things, it's copy in Vim, and paste in Emacs).
...
The complaints about Sublime Text seem to center around the gap between the Sublime Text 3 Beta being announced in 2013 and released in 2017, and a perceived lack of sufficient changes during that period. Sublime Text's release schedule is slow when compared to BBEdit's which has released three major versions ([11](https://www.barebones.com/company/press/bbedit11_pr.html), [12](https://www.barebones.com/company/press/bbedit12_pr.html), and [13](https://www.barebones.com/company/press/bbedit13_pr.html)), while Sublime Text 3 has been in beta. Although [Coda 2](https://panic.com/coda/) from [Panic](https://panic.com/) was released in 2012, and wasn't updated until just recently when its spiritual successor, [Nova](https://nova.app/), was released. That's a gap of around eight years, so it's unclear whether Sublime Text's release schedule is really an anomaly for a commercial text editor.
